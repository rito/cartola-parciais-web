package br.com.devgeek.cartolaparciais.behavior;
...
public class ImageBehavior extends CoordinatorLayout.Behavior<SimpleDraweeView> {
    ...
    private void maybeInitProperties(SimpleDraweeView child, View dependency){
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = (int) Math.round( (mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_content_inset_material) + (finalHeight / 2)) * 2.5 );
