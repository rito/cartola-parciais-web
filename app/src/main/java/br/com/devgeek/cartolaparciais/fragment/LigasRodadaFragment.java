...
import br.com.devgeek.cartolaparciais.adapter.LigasRodadaAdapter;
 ...
 */
public class LigasRodadaFragment extends Fragment {

    private static final String TAG = "LigasRodadaFragment";

    private long ligaId;

    private Realm realm;
    private ApiServiceImpl apiService;
    private LigasRodadaAdapter adapter;
    ...
    public static LigasRodadaFragment newInstance(long ligaId){
        Bundle bundle = new Bundle();
        bundle.putLong("ligaId", ligaId);

        LigasRodadaFragment fragment = new LigasRodadaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        View view  = inflater.inflate(R.layout.fragment_ligastimes_rodada, container, false);
        ...
        adapter = new LigasRodadaAdapter( getActivity() , listaTimesDaLiga );
