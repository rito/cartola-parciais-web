...
//        Realm.setDefaultConfiguration(realmConfig);
        ...
        getSupportActionBar().setTitle("Cartola Parciais");
        toolbar.setTitleTextColor(Color.parseColor("#FFFFFF"));

        setupBuscarTimesParaAdicionar();
    ...
    private void setupBuscarTimesParaAdicionar(){
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchView searchView = (SearchView) MenuItemCompat.getActionView(adicionarTimes);
