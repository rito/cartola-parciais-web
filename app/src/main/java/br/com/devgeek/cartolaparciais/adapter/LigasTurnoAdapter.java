...
public class LigasTurnoAdapter extends RecyclerView.Adapter<LigasTurnoAdapter.ViewHolder> {
    ...
    public LigasTurnoAdapter(Context context, List<TimeLiga> listaTimesDaLiga){
    ...
    public void onBindViewHolder(LigasTurnoAdapter.ViewHolder holder, int position){
        ...
        if (listaTimesDaLiga.get( 0 ).getPontuacaoTurno() != null) pontuacaoParciaisPrimeiroTime = listaTimesDaLiga.get( 0 ).getPontuacaoTurno();
        holder.setData( listaTimesDaLiga.get( position ), backgroundColor, position, listaTimesDaLiga.get( 0 ).getPontuacaoTurno(), pontuacaoParciaisPrimeiroTime);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(TimeLiga time , int backgroundColor, int position, double pontuacaoPrimeiroTime, double pontuacaoParciaisPrimeiroTime){
            ...
            if (time.getAtletas() != null && (time.getVariacaoCartoletas() == null || time.getVariacaoCartoletas() == 0)){
                ...
                SpannableStringBuilder pontuacaoFormatada = new SpannableStringBuilder(padLeft(formatoPontuacao.format(time.getPontuacaoTurno()),8));
                ...
                if (position == 0){
                    ...
                    String diferencaCalculada = "-"+formatoPontuacao.format(pontuacaoParciaisPrimeiroTime-time.getPontuacaoTurno());
                ...
                if (time.getPontuacaoTurno() == null){
                    pontuacao.setText("");
                } else {
