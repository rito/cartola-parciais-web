...
import br.com.devgeek.cartolaparciais.adapter.LigasCartoletasAdapter;
 ...
 */
public class LigasCartoletasFragment extends Fragment {

    private static final String TAG = "LigasCartoletasFragment";

    private long ligaId;

    private Realm realm;
    private ApiServiceImpl apiService;
    private LigasCartoletasAdapter adapter;
    ...
    public static LigasCartoletasFragment newInstance(long ligaId){
        Bundle bundle = new Bundle();
        bundle.putLong("ligaId", ligaId);

        LigasCartoletasFragment fragment = new LigasCartoletasFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        View view  = inflater.inflate(R.layout.fragment_ligastimes_cartoletas, container, false);


        Sort[] sortOrder = { Sort.DESCENDING, Sort.ASCENDING };
        String[] sortColumns = { "patrimonio", "nomeDoTime" };
        ...
        adapter = new LigasCartoletasAdapter( getActivity() , listaTimesDaLiga );
