 ...
 */
@Component
public class RodadasTaskRunner {

    private static final int FIVE_MINUTES = 300000;
    private static final String FIREBASE_DATABASE_REFERENCE = "rodadas";
    private static final String URL = "https://api.cartolafc.globo.com/rodadas";
    private static final SimpleDateFormat dateFormat = new SimpleDateFormat("HH:mm:ss");
    private static final Gson gson = new Gson();

    private FirebaseService firebaseService;

    private static ArrayList<Map<String, Object>> rodadas = null;

    @Autowired
    public RodadasTaskRunner(FirebaseService firebaseService){
        ...
        try {
            ...
            if (apiReturn.getStatusCode() == HttpURLConnection.HTTP_OK && !apiReturn.getResponse().equals("null")){
                ...
                rodadas = gson.fromJson(apiReturn.getResponse(), new TypeToken<ArrayList<HashMap<String, Object>>>(){}.getType());
            }
    ...
    public void buscarDadosApiCartolaFC_rodadas(){

        long startTime = System.currentTimeMillis();
        String task = "RodadasTaskRunner - buscarDadosApiCartolaFC_rodadas |" + dateFormat.format(new Date(startTime)) + "| -> ";
        ...
        try {
            ...
            if (apiReturn.getStatusCode() == HttpURLConnection.HTTP_OK){
                ...
                if (!equalLists(response, rodadas)){
                ...
                System.out.println("RodadasTaskRunner - buscarDadosApiCartolaFC_mercadoDestaques | StatusCode -> " + apiReturn.getStatusCode() + " |");
            }

            System.out.println(task + String.valueOf(System.currentTimeMillis() - startTime) + " ms");

        } catch (Exception e){
            System.out.println("RodadasTaskRunner - buscarDadosApiCartolaFC_rodadas | " + dateFormat.format(System.currentTimeMillis()) + "|");
            e.printStackTrace();
        }
    }
}